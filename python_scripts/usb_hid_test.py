...
# Convertir los valores hexadecimales a ASCII y Braille
hex_values = [
    0xFF, 0xFF, 0x04, 0x00, 0x99, 0x00, 0x50, 0x00, 0x00, 0x47, 0x00, 0x41, 0x00, 0x21, 0x00, 0xEC,
    0x00, 0x21, 0x00, 0xEC, 0x00, 0x00, 0x00, 0x49, 0x00, 0x15, 0x00, 0x1D, 0x00, 0x1D, 0x00, 0x11,
    0x00, 0x09, 0x00, 0x1E, 0x00, 0x11, 0x00, 0x19, 0x00, 0x00, 0x00, 0x24, 0x00, 0x00, 0x00, 0x45,
    0x00, 0x0A, 0x00, 0x1D, 0x00, 0x1B, 0x00, 0x0E, 0x00, 0x1E, 0x00, 0x67, 0x00, 0x4A, 0x00, 0x4E,
    0x00, 0x00, 0x00, 0x0F, 0x00, 0x01, 0x00, 0x1D, 0x00, 0x11, 0x00
]

ascii_values = [chr(value) for value in hex_values if value >= 0x20 and value <= 0x7E]
braille_values = [braille_mapping[f"{value:08b}"] for value in hex_values]

print("Valores en ASCII:", ascii_values)
print("Valores en Braille:", braille_values)
